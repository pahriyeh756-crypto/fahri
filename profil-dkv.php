...
<head>
    ...
    <title>Profil DKV - SMK Al Falah Tanjungjaya</title>
...
<body>
    ...
    <main>
        <section class="page-hero">
            <div class="container">
                <h1 class="animate-fade-in-up">Desain Komunikasi Visual (DKV)</h1>
                <p class="animate-fade-in-up animate-delay-100">Mengasah kreativitas dalam dunia desain dan multimedia</p>
            </div>
        </section>
            ...
            <div class="container">
                <div class="detail-grid">
                    <div class="detail-content">
                        <h2 class="animate-fade-in-up">Tentang Jurusan DKV</h2>
                        <p class="animate-fade-in-up animate-delay-100">Jurusan Desain Komunikasi Visual (DKV) membekali siswa dengan keterampilan dalam desain grafis, animasi, dan produksi multimedia untuk menciptakan karya visual yang komunikatif dan menarik.</p>
                        ...
                        <ul class="competency-list animate-fade-in-up animate-delay-300">
                            <li><i class="fas fa-palette"></i> Desain Grafis dan Ilustrasi</li>
                            <li><i class="fas fa-film"></i> Animasi 2D & 3D</li>
                            <li><i class="fas fa-camera"></i> Fotografi Digital</li>
                            <li><i class="fas fa-video"></i> Produksi Video</li>
                            <li><i class="fas fa-pencil-alt"></i> Drawing dan Sketching</li>
                            <li><i class="fas fa-mobile-alt"></i> Desain UI/UX</li>
                        </ul>
                        ...
                        <div class="career-prospects animate-fade-in-up animate-delay-500">
                            <div class="career-item">
                                ...
                                <p>Membuat desain untuk media cetak dan digital</p>
                            </div>
                            <div class="career-item">
                                <h4>Animator</h4>
                                <p>Membuat animasi untuk film, iklan, dan konten digital</p>
                            </div>
                            <div class="career-item">
                                <h4>UI/UX Designer</h4>
                                <p>Mendesain pengalaman pengguna untuk aplikasi dan website</p>
                            </div>
                            <div class="career-item">
                                <h4>Video Editor</h4>
                                <p>Mengedit video untuk konten kreatif dan komersial</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="detail-sidebar">
                        <div class="sidebar-card animate-fade-in-up">
                            ...
                            <div class="card-body">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value">Adobe Certified</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label"><i class="fas fa-building"></i> Industri Partner</span>
                                    <span class="info-value">Studio Desain, Agency Kreatif</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-card animate-fade-in-up animate-delay-100">
                            <div class="card-header">
                                <h3>Software yang Dipelajari</h3>
                            </div>
                            <div class="card-body">
                                <ul class="facility-list">
                                    <li><i class="fas fa-check"></i> Adobe Photoshop</li>
                                    <li><i class="fas fa-check"></i> Adobe Illustrator</li>
                                    <li><i class="fas fa-check"></i> Adobe Premiere Pro</li>
                                    <li><i class="fas fa-check"></i> Adobe After Effects</li>
                                    <li><i class="fas fa-check"></i> Blender 3D</li>
                                </ul>
                            </div>
                        </div>
                    </div>
